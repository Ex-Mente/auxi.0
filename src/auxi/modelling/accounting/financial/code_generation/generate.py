...
def generateClass(name):
    ...
    resultFilePath = "../../../../../auxi4py/modelling/accounting/financial/" + name + "Wrapper.cpp"
    generateEMObjectsFromTemplate(xsdFilePath, resultFilePath, templateFilePath_py, name)
    resultFilePath = "../../../../../../test/auxi4py/modelling/accounting/financial/unittest_" + name + ".py"
    generateEMObjectsFromTemplate(xsdFilePath, resultFilePath, templateFilePath_unittest_py, name) 


generateClass("GeneralLedgerAccount")
generateClass("GeneralLedgerStructure")

generateClass("TaxRule")
generateClass("IncomeTaxRule")
generateClass("SalesTaxRule")
generateClass("CapitalGainsTaxRule")
generateClass("TaxRuleSet")

generateClass("FinancialCalculationEngine")
generateClass("Transaction")
generateClass("TransactionTemplate")

generateClass("GeneralLedger")