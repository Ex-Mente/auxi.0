...
auxi::modelling::financial::double_entry_system::GeneralLedgerStructure* FinancialCalculationEngine::create_generalLedgerStructure(std::string name)
{
    auto generalLedger_structure = new auxi::modelling::financial::double_entry_system::GeneralLedgerStructure(name, "");
