...
def generateClass(name):
    ...
    resultFilePath = "../../../../../auxi4py/modelling/financial/calculation_engines/" + name + "Wrapper.cpp"
    generateEMObjectsFromTemplate(xsdFilePath, resultFilePath, templateFilePath_py, name)
    resultFilePath = "../../../../../../test/auxi4py/modelling/financial/calculation_engines/unittest_" + name + ".py"
