...
def generateClass(name):
    ...
    resultFilePath = "../../../../../auxi4py/modelling/financial/tax/" + name + "Wrapper.cpp"
    generateEMObjectsFromTemplate(xsdFilePath, resultFilePath, templateFilePath_py, name)
    resultFilePath = "../../../../../../test/auxi4py/modelling/financial/tax/unittest_" + name + ".py"
    generateEMObjectsFromTemplate(xsdFilePath, resultFilePath, templateFilePath_unittest_py, name) 


generateClass("Rule")
generateClass("IncomeRule")
generateClass("SalesRule")
generateClass("CapitalGainsRule")
generateClass("RuleSet")