...
#ifndef UNORDERED_MAP_INDEXING_SUITE_JDG20038_HPP
# define UNORDERED_MAP_INDEXING_SUITE_JDG20038_HPP
...
namespace boost { namespace python {
    ...
    namespace detail
    {
        ...
        class final_unordered_map_derived_policies
            : public unordered_map_indexing_suite<Container,
                NoProxy, final_unordered_map_derived_policies<Container, NoProxy> > {};
    }

    // The unordered_map_indexing_suite class is a predefined indexing_suite derived
    ...
    //          .def(unordered_map_indexing_suite<std::map<std::string, X> >())
    //      ;
    //
    ...
    template <
        ...
        class DerivedPolicies
            = detail::final_unordered_map_derived_policies<Container, NoProxy> >
    class unordered_map_indexing_suite
    ...
    public:
        ...
        {
            return false; //container.key_comp()(a, b);
        }
...
#endif // unordered_map_indexing_suite_JDG20038_HPP
